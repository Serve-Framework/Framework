...
class Query
{
	 ...
	 * Constructor.
	 *
	 * @param \serve\database\connection\ConnectionHandler $connectionHandler
	 */
	...
	*******************************************************************************************************/
	 ...
	 * @param mixed  $value  Comparison value
	 */
	public function and_where(string $column, string $op, $value): void
	{
	 ...
	 * @param mixed  $value  Comparison value
	 */
	public function or_where(string $column, string $op, $value): void
	{
	 ...
	 * @param string $columns   Column comparison e.g table1.id = table2.column_name
	 */
	public function inner_join(string $tableName, string $columns): void
	{
		$this->join($tableName, $columns);
	}
